...
<head>
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{asset('vendor/admin-lte/dist/css/a.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/admin-lte/dist/css/font-awesome.min.css')}}">
{{--    <link rel="stylesheet" href="{{asset('vendor/admin-lte/dist/css/ionicons.min.css')}}">--}}
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{route('admin')}}" class="logo">
            ...
            <span class="logo-lg"><b>Best Service</b></span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('vendor/admin-lte/dist/img/user3-128x128.jpg')}}"
                                                     class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('vendor/admin-lte/dist/img/user4-128x128.jpg')}}"
                                                     class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('vendor/admin-lte/dist/img/user2-160x160.jpg')}}" class="user-image"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    Admin
                                    <small>当前日期：{!! date('Y-m-d',time()) !!}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{route('profile')}}" class="btn btn-default btn-flat">个人中心</a>
                                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="{{route('admin.user.index')}}"><i class="fa fa-circle-o"></i>添加讲师</a></li>
                        <li class="active"><a href="{{route('admin.user.create')}}"><i class="fa fa-circle-o"></i>添加用户</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('admin.course.index')}}"><i class="fa fa-circle-o"></i> 权限管理</a></li>
                        <li class="active"><a href="{{route('admin.course.create')}}"><i class="fa fa-circle-o"></i> 角色管理</a></li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2011-2017 <a href="http://www.ibestservice.com">安徽百得思维信息科技有限公司</a>.</strong> All rights
        reserved. 版权所有 皖ICP备16015303号-1
    </footer>
...
{{--<script src="{{asset('vendor/admin-lte/bootstrap/js/jquery.min.js')}}"></script>--}}
<!-- Bootstrap 3.3.6 -->
...
{{--<script src="{{asset('vendor/layer-v3.0.3/layer/layer.js')}}"></script>--}}
<script>
    $.ajaxSetup({
        headers: {
